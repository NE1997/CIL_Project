...
flags.DEFINE_boolean('load_senti', True, 'load sentiment score')
...
out_log = "./log/senti/" + "/noabs/" + str(FLAGS.sca) + "_" + str(FLAGS.batch_size) + "_" + str(FLAGS.random_batch_no) + \
...
prediction_record = "./log/prediction_sat.txt"

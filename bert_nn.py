...
data = pd.DataFrame()        
temp_df = pd.read_csv("twitter-datasets/train_full_all.csv", encoding='utf-8').reset_index(drop=True)
...
with open("twitter-datasets/submission.csv", "w", encoding='UTF8') as of:
